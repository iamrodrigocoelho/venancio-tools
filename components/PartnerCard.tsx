    ...
    <article className="bg-white rounded-2xl border border-[#E8E4D9] p-6 flex flex-col gap-4 hover:-translate-y-1 hover:shadow-lg hover:border-[#C9A265]/40 transition-all duration-200 cursor-default">
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-center gap-3 min-w-0">
          {/* Logo circle */}
          <div className="w-12 h-12 rounded-xl bg-[#0F1E3C] text-white flex items-center justify-center font-bold text-sm flex-shrink-0 tracking-wide">
            {partner.logo}
          </div>
          {/* Category chip */}
          <span className="text-xs px-2.5 py-1 rounded-full bg-[#F0EDE6] text-[#6B7280] font-medium whitespace-nowrap">
            {partner.category}
          </span>
        </div>
